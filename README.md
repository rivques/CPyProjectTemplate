...
2. FIlling in your actual information, run the following commands. The paste shortcut is `Shift+Insert` or you can right click then hit paste. Spelling must match exactly:
```
